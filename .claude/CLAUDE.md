...
- always use the CSS variables and utility classes from pwa/src/styles for fonts, colours and spacing. Don't hardcode pixel values for width, spacing or font size in page-level CSS modules
